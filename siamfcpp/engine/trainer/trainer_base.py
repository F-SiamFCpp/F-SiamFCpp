...
class TrainerBase:
    ...
    def load_snapshot(self):
        ...
        snapshot = torch.load('/home/lsw/PycharmProjects/siamfc_Fisher/siamfc_6/models/pretrained_models/alexnet-nopad-bn-md5.pkl',
                              map_location=dev)
    ...
    def load_backbone_head_pretrained(self, oristate_dict):
        ...
        cnt = 0
        ranks_path = '/home/lsw/PycharmProjects/siamfc_Fisher/siamfc_6/rank_conv/ranks_avg_fisher.npy'
