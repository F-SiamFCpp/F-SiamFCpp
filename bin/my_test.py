...
if model==1:
    config='/home/lsw/PycharmProjects/siamfc_Fisher/siamfc_6/models/siamfcpp/test/vot/siamfcpp_alexnet.yaml'   #VOT
if model==2:
    config='models/siamfcpp/test/otb/siamfcpp_alexnet-otb.yaml'#OTB  
if model==3:
    config='/home/lsw/PycharmProjects/siamfc_Fisher/siamfc_6/models/siamfcpp/test/dtb70/siamfcpp_alexnet-dtb70.yaml'#DTB
if model==4:
    config='/home/lsw/PycharmProjects/siamfc_Fisher/siamfc_6/models/siamfcpp/test/uav123/siamfcpp_alexnet-uav123.yaml'#UAV123
if model==5:
    config='/home/lsw/PycharmProjects/siamfc_Fisher/siamfc_6/models/siamfcpp/test/uav20l/siamfcpp_alexnet-uav20l.yaml'#UAV20L
if model==6:
    config='/home/lsw/PycharmProjects/siamfc_Fisher/siamfc_6/models/siamfcpp/test/uavdt/siamfcpp_alexnet-uavdt.yaml'#UAVDT
if model==7:
    config='/home/lsw/PycharmProjects/siamfc_Fisher/siamfc_6/models/siamfcpp/test/visdrone/siamfcpp_alexnet-visdrone2019.yaml'#visdrone
if model==8:
    config='/home/lsw/PycharmProjects/siamfc_Fisher/siamfc_6/models/siamfcpp/test/uav123@10fps/siamfcpp_alexnet-uav123@10fps.yaml'#UAV123@10fps
if model==9:
    config='/home/lsw/PycharmProjects/siamfc_Fisher/siamfc_6/models/siamfcpp/test/visdrone/siamfcpp_alexnet-visdrone2018.yaml'#visdrone2018
...
if __name__ == '__main__':
    ...
    parser.add_argument('-model_path', '--model_path', default='/home/lsw/PycharmProjects/siamfc_Fisher/siamfc_6/models/snapshots/siamfcpp_alexnet-got/epoch-17.pkl',type=str,help='experiment configuration')  # 为空则选择yaml里面默认的模型
   ...
   # print(root_cfg.test.track.model.task_model.SiamTrack.pretrain_model_path)
    ...
    ROOT_PATH  =os.getcwd()
    ROOT_PATH = '/home/lsw/PycharmProjects/siamfc_Fisher/siamfc_6'
